...
(function($, window, document, undefined) {
  ...
  Timepicker.prototype = {
    ...
    _init: function() {
      ...
      if (this.$element.parent().hasClass('input-group') || this.$element.parent().hasClass('input-append')) {
        this.$element.parent('.input-group, .input-append').find('.input-group-addon,.add-on').on({
